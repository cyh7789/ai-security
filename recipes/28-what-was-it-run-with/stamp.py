...
為什麼是這五格：Day 26 那份 POSITIONING.md 自己寫著「換模型、換量化版本、
換提示、換掃描的語言，這份聲明就過期」。前三樣直接對得上；第四樣要記的是
實際掃了哪幾個檔，另外加一格記跑它的那支腳本。這支把那些散文變成
機器對得起來的值。
