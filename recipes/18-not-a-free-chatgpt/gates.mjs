...
export const SCENARIO = {
  ...
  發票: ["發票", "統編", "報帳"],
  帳號問題: ["登入", "密碼", "帳號", "註冊"],
  客服信件: ["客服信", "回覆客戶", "通知信", "公告", "信件開頭", "結尾", "語氣"],
};
...
// 現在回 deny，因為命中「假冒」。一句防詐宣導被自己的閘擋掉。
// 所以這一層的定位是「便宜的明顯濫用篩選」，不是安全邊界。要不要真的攔，
// 得看誤擋率、繞過率跟它省下的模型呼叫，而這個 recipe 這三個數都沒量。
//
// 「騙」在 Day 21 拿掉了，因為它擋掉的第一句話是防詐宣導。代價要講明白：
// 一句只用到「騙」、不碰其他六個詞、而且命中得了下面那份允許清單的釣魚信要求，從此過得了輸入側
// （recipe 21 的 b1 就是那句，8/20 實測過）。現在擋著它的是模型自己不寫，
// 那是供應商的對齊，不是我的防線。這個缺口沒有被修掉，它被寫成一條測試釘在那裡。
